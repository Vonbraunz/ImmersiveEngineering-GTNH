...
@Mod(modid=ImmersiveEngineering.MODID,name=ImmersiveEngineering.MODNAME,version = Tags.VERSION, dependencies="after:Railcraft;after:TConstruct;after:ThermalFoundation;after:Avaritia", acceptedMinecraftVersions="[1.7.10]")
public class ImmersiveEngineering
{
	...
	{
		IELogger.debug = Tags.VERSION.startsWith("GRADLETOKEN");
		Config.init(event);
		IEContent.preInit();
